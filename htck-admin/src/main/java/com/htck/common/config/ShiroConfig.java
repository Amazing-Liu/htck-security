...
import com.htck.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/business/post/listPost", "anon");
        filterMap.put("/business/post/getPost", "anon");
        filterMap.put("/business/post/listByIds", "anon");
        filterMap.put("/business/candidateinfo/apply", "anon");
        filterMap.put("/**", "authc");
